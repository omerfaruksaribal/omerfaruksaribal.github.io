...
By downloading, installing, or using UniBudget ("App"), you agree to be bound by these Terms of Use ("Terms"). If you do not agree, do not use the App.
...
- You are responsible for all activities on your device
...
- All content, features, and functionality are owned by UniBudget
- You may not copy, modify, or distribute the App
- "UniBudget" name and logo are trademarks
